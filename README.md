...
- [Capítulo V: Product Implementation, Validation & Deployment](#1)
  ...
  - [5.2. Landing Page, Services & Applications Implementation](#7)
    ...
    - [5.2.3. Sprint 3](#26)
      - [5.2.3.1.Sprint Planning 3.](#27)
      - [5.2.3.2.Sprint Backlog 3.](#28)
      - [5.2.3.3.Development Evidence for Sprint Review.](#29)
      - [5.2.3.4.Testing Suite Evidence for Sprint Review.](#30)
      - [5.2.3.5.Execution Evidence for Sprint Review.](#31)
      - [5.2.3.6.Services Documentation Evidence for Sprint Review.](#32)
      - [5.2.3.7.Software Deployment Evidence for Sprint Review.](#33)
      - [5.2.3.8.Team Collaboration Insights during Sprint.](#34)
      - [5.3. Validation Interviews](#35)
      - [5.3.1. Diseño de Entrevistas](#36)
      - [5.3.2. Registro de Entrevistas](#37)
      - [5.3.3. Evaluaciones según heurísticas](#38)
      - [5.4. Video About-the-Product](#39)
        

- [Conclusiones](#40)
  - [Conclusiones y recomendaciones](#41)
  - [Video About-the-Team](#42)
...
| :-: | :-: | :-: |
|Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software.|<p>Orlando Arturo Roca Huapaya </p><p>TB1 </p><p>En esta entrega me encargué de realizar revisiones oportunas en el trabajo para realizar un correcto desarrollo del TB1. Asimismo, participé en el desarrollo de la idea de negocio </p><p>Gonzales Gomez, Antonella </p><p>TB1 </p><p>Para el desarrollo del proyecto, se tuvo que identificar un problema o una necesidad latente, nuestro startup resuelve la necesidad de dos segmentos de usuarios, a través de las diferentes funcionalidades de nuestra aplicación. </p><p>Aguirre Rodríguez, Gustavo Jandroel </p><p>TB1 </p><p>En el proceso, tuve que identificar las funciones esenciales del aplicativo y analizar el pensamiento del público objetivo para guiar la creación del diseño del web application. </p><p>Louis Piero Alfaro Coveñas </p><p>TB1 </p><p>En esta entrega tuve que ver con qué software me ayudaría para realizar el capítulo 2 del trabajo y analizar cómo lo que nuestro sistema embarca y con qué lenguaje pensaba programar el diseño de la estructura de nuestro sistema </p><p>Louis Piero Alfaro Coveñas </p><p>TP </p><p>Me encargué de pasar el proyecto del markdown a Word con todas las correcciones respectivas </p><p>Gustavo Jandroel Aguirre Rodríguez </p><p>TP </p><p>Me encargué del Execution Evidence for Sprint Review y el Software Deployment Evidence for Sprint Review </p><p>Farid Rolando Hinostroza Mavila </p><p>TP </p><p>Me encargué de mejoras del documento y sprint pasado, a su vez implementar la primera versión del frontend desplegado. Antonella Gonzales Gomez </p><p>TP </p><p>Para el desarrollo del front-end se tuvo que realizar sprint planning 2 y el sprint Backlog 2. </p><p>Orlando Arturo Roca Huapaya</p><p>` `TP</p><p>Realicé la implementación del frontend utilizando el framework Angular en el entorno de desarrollo WebStorm, empleando las tecnologías HTML y CSS.</p><p></p><p>Farid Rolando Hinostroza Mavila</p><p>` `TP</p><p>Me encargue de mejorar el frontend en el aprtado de payments y suscripciones.</p><p></p><p>Orlando arturo Roca Huapaya</p><p>`  `TB2</p><p>Me encargue de mejorar el frontend utilizando fake api, con la finalidad de probar si las funcionalidades del frontend funcionaban.</p>|Los estudiantes demostraron una capacidad efectiva para trabajar en equipos multidisciplinarios en el contexto de proyectos de ingeniería de software. Realizaron revisiones oportunas, contribuyeron al desarrollo de ideas de negocio y participaron en la identificación de problemas y necesidades. También se encargaron de aspectos esenciales del desarrollo del aplicativo y la implementación del frontend. Además, realizaron tareas de gestión y documentación relacionadas con la entrega del proyecto. En general, los estudiantes mostraron un compromiso con la eficacia, eficiencia y objetividad en su trabajo en equipo.|
|Conoce al menos un sector empresarial o dominio de aplicación de soluciones de software.|<p>Orlando Arturo Roca Huapaya </p><p>TB1 </p><p>Me encargué de realizar el análisis competitivo, los wireframes y mock-ups de la landing page, el diagrama de clases y el diagrama de base de datos </p><p>Gonzales Gomez, Antonella </p><p>TB1 </p><p>Me encargué de la gestión de la configuración del software y de las herramientas utilizadas en diferentes aspectos del proyecto. Estas herramientas abarcan desde la gestión de proyectos hasta el desarrollo, pruebas, documentación y despliegue del software. </p><p>Aguirre Rodríguez, Gustavo Jandroel </p><p>TB1 </p><p>En este trabajo, mi responsabilidad abarcó el diseño de entrevistas, la recolección y análisis de datos, así como la creación de diseños en Figma para la aplicación web. Además, utilicé Lucidchart para confeccionar diagramas relevantes. </p><p>Louis Piero Alfaro Coveñas </p><p>TB1 </p><p>Me encargué de los Customer Journey Mapping, Empathy Mapping, As-is Scenario Mapping como también de DOMAIN-DRIVEN SOFTWARE ARCHITECTURE. </p><p>Farid Hinostroza Mavila </p><p>TB1 </p><p>Me encargué de las historias de usuario y product backlog, a su vez, definiciones en el capítulo I diseño de la edición del video </p><p>Louis Piero Alfaro Coveñas </p><p>TP </p><p>Me encargué de hacer una mejora a los C4 del proyecto </p><p>Gustavo Jandroel Aguirre Rodríguez </p><p>TP </p><p>Me dediqué a llevar a cabo la implementación de la aplicación web en el ámbito de componentes, y progresé en el capítulo 5 </p><p>Farid Rolando Hinostroza Mavila </p><p>TP </p><p>Desarrollé mejoras al sprint pasado, gracias al trabajo en equipo y retrospectivas continuas para emplear un buen TP. </p><p>Antonella Gonzales Gomez </p><p>TP </p><p>He realizado el sprint Backlog 2 desde las historias de usuario para realizar el front-end de nuestro negocio. </p><p>Orlando Arturo Roca Huapaya </p><p>TP</p><p>Conduje la implementación del frontend con Angular en el entorno de desarrollo WebStorm, en el ámbito especializado de la venta de componentes, orquestando una aplicación web que destila la esencia del mercado y sus desafíos</p><p>Orlando Arturo Roca Huapaya </p><p>TB2</p><p>Aporte en el desarrollo del backend utilizando el framework sping boot, y realice endpoints como obtener usuario y registrar usuario</p> <p>Farid Rolando Hinostroza Mavila </p><p>TB2</p><p>Me encargué de la gestión del sprint 3 asignando estimaciones en el backlog y mejoras en el frontend</p> |Los estudiantes demostraron un conocimiento sólido de al menos un sector empresarial o dominio de aplicación de soluciones de software. Realizaron análisis competitivos, diseñaron wireframes y mock-ups, crearon diagramas de clases y bases de datos, y gestionaron herramientas relacionadas con el desarrollo de software. Además, se encargaron de la recolección y análisis de datos, diseñaron entrevistas y utilizaron herramientas de diseño como Figma y Lucidchart. En general, los estudiantes demostraron un entendimiento profundo de los aspectos empresariales y técnicos de su dominio de aplicación.|
...
[**5.2.3.1. Sprint Planning 3.** ](https://github.com/NanoNerdsGroup/NanoNerds-Report#5223-sprint-planning-3-)
