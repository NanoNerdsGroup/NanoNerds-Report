...
|:-----|:-------|:-|
| <p>**Participa en equipos** </p><p>**multidisciplinarios con eficacia,** </p><p>**eficiencia y objetividad, en el** </p><p>**marco de un proyecto en** </p><p>**soluciones de ingeniería de** </p><p>**software.**</p>| <p>**Orlando Arturo Roca Huapaya**</p><p>**TB1**</p><p>En esta entrega me encargue de realizar revisiones oportunas en el trabajo para realizar un correcto desarrollo del TB1. Asimismo, participe en el desarrollo de la idea de negocio</p><p></p><p>**Gonzales Gomez, Antonella**</p><p>**TB1**</p><p>` `Para el desarrollo del proyecto, se tuvo que identificar un problema o una necesidad latente, nuestro startup resuelve la necesidad de dos segmentos de usuarios, a través de las diferentes funcionalidades de nuestra aplicación.</p><p></p><p>**Aguirre Rodríguez, Gustavo Jandroel**</p><p>**TB1**</p><p>En el proceso, tuve que identificar las funciones esenciales del aplicativo y analizar el pensamiento del público objetivo para guiar la creación del diseño del web application.</p><p></p><p>**Louis Piero Alfaro Coveñas**</p><p>**TB1**</p><p>En esta entrega tuve que ver con que software me ayudaría para realizar el capítulo 2 del trabajo y analizar cómo lo que nuestro sistema embarca y con qué lenguaje pensaba programar el diseño de la estructura de nuestro sistema</p><p>**Louis Piero Alfaro Coveñas**</p><p></p> <p>**TP**</p><p>Me encargue de pasar el proyecto del markdown a word con todas las correcciones respectivas</p> <p>**Gustavo Jandroel Aguirre Rodríguez**</p><p></p> <p>**TP**</p><p>Me encargue del Execution Evidence for Sprint Review y el Software Deployment Evidence for Sprint Review</p>  <p>**Farid Rolando Hinostroza Mavila**</p><p></p> <p>**TP**</p><p>Me encargue de mejoras del documento y sprint pasado, a su vez implementar la primera version del frontend desplegado. <p>**Antonella Gonzales Gomez**</p><p></p> <p>**TP**</p><p>Para el desarrollo del front-end se tuvo que realizar sprint planning 2 y el sprint Backlog 2. </p> <p>**Orlando Arturo Roca Huapaya**</p><p></p> <p>**TP**</p><p>Realicé la implementación del frontend utilizando el framework Angular en el entorno de desarrollo WebStorm, empleando las tecnologías HTML y CSS." </p> <p>**Louis Piero Alfaro Coveñas**</p><p>**TB2**</p><p>Me encargue hacer la sección de “VER MÁS” en el frontend</p>|  |                                                                                                                                          |<br>|
| <p>**Conoce al menos un sector** </p><p>**empresarial o dominio de** </p><p>**aplicación de soluciones de** </p><p>**software.**</p>                                                                                 | <p>**Orlando Arturo Roca Huapaya**</p><p>**TB1**</p><p>Me encargue de realizar el analisis competitivo, los wireframes y mock-ups de la landing page, el diagrama de clases y el diagrama de base de datos</p><p></p><p>**Gonzales Gomez, Antonella**</p><p>**TB1**</p><p>` `Me encargue de la gestión de la configuración del software y de las herramientas utilizadas en diferentes aspectos del proyecto. Estas herramientas abarcan desde la gestión de proyectos hasta el desarrollo, pruebas, documentación y despliegue del software. </p><p></p><p>**Aguirre Rodríguez, Gustavo Jandroel**</p><p>**TB1**</p><p>En este trabajo, mi responsabilidad abarcó el diseño de entrevistas, la recolección y análisis de datos, así como la creación de diseños en Figma para la aplicación web. Además, utilicé Lucidchart para confeccionar diagramas relevantes.</p><p>**Louis Piero Alfaro Coveñas**</p><p>**TB1**</p><p>Me encargue de los Customer Journey Mapping, Empathy Mapping, As-is Scenario Mapping</p><p>como también de DOMAIN-DRIVEN SOFTWARE ARCHITECTURE. </p> </p><p>**Farid Hinostroza Mavila**</p><p>**TB1**</p><p>Me encargue de las historias de usuario y product backlog, a su vez, definiciones en el capitulo I</p><p>diseño de la edición del video  </p> </p><p>**Louis Piero Alfaro Coveñas**</p><p></p> <p>**TP**</p><p>Me encargue de hacer una mejora a los C4 del proyecto </p> <p>**Gustavo Jandroel Aguirre Rodríguez**</p><p></p> <p>**TP**</p><p>Me dediqué a llevar a cabo la implementación de la aplicación web en el ámbito de componentes, y progresé en el capítulo 5</p> <p>**Farid Rolando Hinostroza Mavila**</p><p></p> <p>**TP**</p><p>Desarrollé mejoras al sprint pasado, gracias al trabajo en equipo y restrospectivas continuas para emplear un buen tp. <p>**Antonella Gonzales Gomez**</p><p></p> <p>**TP**</p><p>He realizado el sprint Backlog 2 desde las historias de usuario para realizar el front-end de nuestro negocio.</p>  <p>**Orlando Arturo Roca Huapaya**</p><p></p> <p>**TP**</p><p>Conduje la implementación del frontend con Angular en el entorno de desarrollo WebStorm, en el ámbito especializado de la venta de componentes, orquestando una aplicación web que destila la esencia del mercado y sus desafíos." </p><p>**Louis Piero Alfaro Coveñas**</p><p>**TB2**</p><p>Aporte en la documentación de esta TB2 haciendo los diseños y entrevistas de segmentos objetivos y las heurísticas realizadas de acuerdo a las entrevistas</p>
|||
...
<tr>
    <td style="border: 1px solid #dddddd; padding: 8px;">
      <center><img src="https://media.discordapp.net/attachments/610911183339388978/1149964365613764618/xddddd.jpeg?width=150&height=250"></center>
    </td>
  </tr>
<br>
...
En una entrevista con Carlos Peña Ojeda, un entusiasta de las computadoras, se destacó su preferencia por las compras en línea debido a su comodidad. Expresó su deseo de mejorar la experiencia de compra en la página web proporcionada. Carlos, un experto en componentes, enfatizó la importancia de facilitar la navegación y búsqueda de productos, sugiriendo un apartado de comentarios para los usuarios, así como una amplia visualización de precios para comparar.

Además, hizo hincapié en la personalización, manifestando su interés en la posibilidad de personalizar los iconos en la página web. Su objetivo principal era optimizar la experiencia del usuario y hacer que la compra de componentes informáticos fuese más intuitiva y personalizada.

![](https://cdn.discordapp.com/attachments/610911183339388978/1170107942356402338/image.png)

![](https://cdn.discordapp.com/attachments/610911183339388978/1170108051152457768/image.png)

Link de la entrevista: <https://youtu.be/RcQfAQ6ttVM>


Entrevista 3

Entrevista con Yereme Baltazar, entusiasta de la informática:

Yereme Baltazar, un apasionado de la informática, reveló su preferencia por las compras en línea debido a su comodidad. Se autodenomina experto en componentes informáticos y expresó su deseo de mejorar la experiencia de compra en la página web mencionada. Sugirió la inclusión de un apartado de comentarios para interacción, así como la exhibición de una amplia gama de precios.

Además, Yereme destacó su interés en la personalización de iconos en la página, añadiendo que le gustaría ver foros y reseñas para verificar la autenticidad de los productos. Destacó la importancia de la capacidad de comparar precios con otras tiendas en línea para tomar decisiones informadas.

![](https://cdn.discordapp.com/attachments/610911183339388978/1170117131908685854/image.png)

![](https://cdn.discordapp.com/attachments/610911183339388978/1170117199772532796/image.png)

Link de la entrevista: <https://youtu.be/kSvwg1Jzy0Y>
...
Leonardo López, un vendedor de componentes de computadora, muestra interés en la propuesta de nuestra web app de intermediación. Desea utilizar la plataforma para promocionar su tienda en línea, resaltando la calidad de los componentes que ofrece. Leonardo destaca la importancia de una función de personalización dentro de la aplicación para brindar una experiencia más adaptada a sus clientes. Aunque está satisfecho con el diseño y las funcionalidades generales de la aplicación, expresa su deseo de modificar el esquema de colores, ya que considera que el diseño actual es demasiado blanco y le gustaría ajustarlo para reflejar mejor su marca o sus preferencias personales.

![](https://cdn.discordapp.com/attachments/610911183339388978/1170122453859713104/image.png)

![](https://cdn.discordapp.com/attachments/610911183339388978/1170122639101136966/image.png)

Link de la entrevista: <https://youtu.be/lSW8oxl1mzg>

Entrevista 3

Diego Ramírez, un vendedor de componentes de computadora, está interesado en nuestra propuesta de web app para intermediarios. Quiere promocionar su tienda en línea, resaltando sus productos de marcas reconocidas. Además, busca una función de personalización para expandir su presencia en este sector. Diego también compara precios con la competencia. Opina que el diseño actual es demasiado básico y le gustaría mejorarlo, aunque en general le agrada el diseño y las funcionalidades.

![](https://cdn.discordapp.com/attachments/610911183339388978/1170102266183811133/image.png)

![](https://cdn.discordapp.com/attachments/610911183339388978/1170103338646392883/image.png)

Link de la entrevista: <https://youtu.be/s-rUYgCeI28>
...
[Link del Web Application](https://nanonerds-techshop.web.app/)

[About the Team](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202124162_upc_edu_pe/EcQgfvl4erdBpcWXApZBLfQBzTR8uPXRcVSKCiPiISqWvw?e=gDxTPP&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZyIsInJlZmVycmFsQXBwUGxhdGZvcm0iOiJXZWIiLCJyZWZlcnJhbE1vZGUiOiJ2aWV3In19  )

[About The Product](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202124162_upc_edu_pe/ERyuZAp2jJNPjRZz_TlLOpEBfd4RO7P52LVwrD1UrqASQw?e=Tp9Dpm&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZyIsInJlZmVycmFsQXBwUGxhdGZvcm0iOiJXZWIiLCJyZWZlcnJhbE1vZGUiOiJ2aWV3In19   )
